...
return [
    ...
    */
    ...
    'hide_matching' => [
        ...
        '#^_ignition#',
        '#^_tt#',
        // '#^(?!.*api\.)#', // This will only show routes on api subdomain
    ],

    // You can also specify middleware
    // 'only_middlewares' => [
    //     'api', // Only show routes with 'api' middleware
    // ],

    // Specify the domain
    // 'only_domains' => [
    //     config('app.api_domain'), // Only show routes on your API domain
    // ],
