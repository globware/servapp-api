<x-admin-layout>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6">
            ...
            @if($service->media->count() > 0)
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Media Gallery</h3>
    ...
    <div id="mediaModal" class="fixed inset-0 bg-black bg-opacity-75 hidden items-center justify-center z-50" onclick="closeMediaModal()">
        <div class="max-w-4xl max-h-screen p-4" onclick="event.stopPropagation()">
            <div class="relative">
                <button onclick="closeMediaModal()" class="absolute top-4 right-4 text-white hover:text-gray-300">
    ...
    <script>
        ...
        function openMediaModal(src, type) {
            ...
            if (type === 'image') {
                modalContent.innerHTML = `<img src="${src}" class="max-w-full max-h-screen object-contain">`;
            }
