        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($service->media->count() > 0)
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
    <div class="flex gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
        @foreach($service->media as $file)
            ...
            <div
                class="group relative w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 flex-shrink-0 cursor-pointer"
                onclick="openMediaModal('{{ $fileUrl }}', '{{ $file->mime_type }}', '{{ $file->original_filename }}')"
            >
                <div class="rounded-lg overflow-hidden border-2 border-gray-200 group-hover:border-indigo-500 transition-all duration-200 group-hover:shadow-lg">
                    @if($isImage)
                        <img src="{{ $fileUrl }}" width="100" height="60"
